...
export default function FileDisplay(props) {
    const {resetAudio, file, audioStream, submitForm} = props
    ...
    return (
        ...
        <div className='flex items-center justify-between gap-4'>
            <button onClick={resetAudio} className='text-slate-400 hover:text-blue-600 duration-200'>Reset</button>
            <button onClick={submitForm} className='specialBtn  px-3 p-2 rounded-lg text-blue-400 flex items-center gap-2 font-medium '>
                <p>Transcribe</p>
